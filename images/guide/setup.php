    ...
    <div class="row">
      ...
      <div class="col-md-3" id="leftCol">
        <ul class="nav nav-stacked" id="sidebar">
          ...
          <li><a href="#sec12">Manage Returns</a></li>
        </ul>
      </div><!--/left-->
      ...
      <div class="col-md-9">
        ...
        <img src="/frontend/images/guide/install-app.png" />
        ...
        <img src="/frontend/images/guide/installation-app.png" />
        ...
        <p>
            ...
            <img src="/frontend/images/guide/configuration-settings.png" />
            As shown in above fields you can enter the different details of the jet settings. We have explained the jet.com fields below-
            <ul>
                ...
                <img src="/frontend/images/guide/configuration-api-link.png" />
                On the above screen you can click on the <b>Get API Keys</b> to get the real credential of the jet.com.
                <img src="/frontend/images/guide/configuration-api-details.png" />
                On the above screen you can see the first details is about the <b>API USER</b>.
                </li>
                
                <li><b>Api Password</b> details can also be get from the above screen where you can use the <b>Secret</b> details as the API Password.</li>
                <li><b>Api Fulfillment Node Id</b> can be found by going to the <b>Fulfillment</b> menu shoing in the left section. After clicking there if there is no any fulfillment node created then you need to create a node there. After then you can see the details of your <b>Fulfillment Node Id</b> 
                <img src="/frontend/images/guide/configuration-api-fulfillment.png" />
                </li>
                <li>
                    <b>Merchant's Email</b> can be set by you in this email all the new orders email notification will be sent.                     
                </li>
                <li><b>Jet Return Location</b> address can be set here. It will be your default return location for your orders.</li>
            </ul>

            <span class="note"> Here is some important notes we are mentioning that when you first time setup your jet.com partner panel with our app. Means when you do not have the Live API details of the Jet.com then you need to enter the <b>Test API credential</b>. After adding the Test API credential you need to <b>Activate All API</b>> calling then you will be able to access  the <b>LIVE Jet API details</b></span>
        </p>
        ...
        <p>
            ...
            When you setup your TEST API details then you need to activate them to get the LIVE API DETAILS. Please go to the following <a href="<?= $hostname ?>frontend/jetapi/index" target="_blank"><?= $hostname ?>frontend/jetapi/index</a> url.
            <img src="/frontend/images/guide/activate-api.png" />
            ...
            <img src="/frontend/images/guide/activate-api-order-generator.png" />
            ...
            <span class="note">When you activated all the LIVE API keys by this process, Then you will get the LIVE API credential switch the partner panel to the live and get API Details. You need to <a href="<?= $hostname ?>frontend/jetapi/index" target="_blank">update the configuration details of app with the LIVE API credentail</a> as you get it. You can get the details of the live api by the following screen.

            <img src="/frontend/images/guide/configuration-livedetails.png" />
             </span>
        ...
        <p>
            To map the category in mass just go to Top menu <b>Jet -> <a href="<?= $hostname ?>frontend/categorymap/index" target="_blank">Category Map</a></b>. By clicking there you can find the following screen.
            
        </p>
        <img src="/frontend/images/guide/map-category-jet.png" />
        <p>
        ...
        <p>
          ...
          <ul>
            <li>First of all go to the Shopify app panel and after login you can see the top menu <b> JET -> Manage Products -> <a href="<?= $hostname ?>frontend/jetproduct/index" target="_blank">Upload Products</a> </b>. After going to upload products you can see all the shopify products listed on our app. </li>
            <li>
                Shopify products listing can be found as below screen. Here are the different self explainatory columns are listed. 
                <img src="/frontend/images/guide/shopify-product-listing.png" />
                <b>
                    NOTE: 
            ...
            <li>
                ...
                <img src="/frontend/images/guide/product-edit-general-info.png" />
            ...
            <img src="/frontend/images/guide/category-nonvariant.png" /> <img src="/frontend/images/guide/attribute-nonvariant.png" />
            ...
            <img src="/frontend/images/guide/category-variant.png" /> <img src="/frontend/images/guide/attribute-variant.png" />
        ...
        After editing all the products information properly click on the top button "Save and Upload" for instantly uploading the products to jet.com. Or you can click on "Save" button to save the products information.
            <img src="/frontend/images/guide/product-save-n-upload.png" />
        </p>

        <b>Mass Upload Product</b>
        <p>After editing all the products properly means. Each products must have their UPC, Quantity, Attribute values, Price information. Then you can upload products at once. Go to the top menu <b>Jet -> Manage Products -> <a href="<?= $hostname ?>frontend/jetproduct/index" target="_blank">Upload Products</a></b>. By going to this page you can find all the products now you can upload the products. On the left most column tick all the checkboxes in the product list. After selection Upload / Archive / Unarchive then click on submit.</p>
        ...
        <p>UnArchive: These are the non live products and you want to re-enable the products on Jet.com you can unarchive the product.</p>
            <img src="/frontend/images/guide/product-mass-upload.png" />
        </p>
        ...
        <h2 id="sec7">Rejected Products</h2>
            ...
            <p>You can get all the rejected products listing by going to top menu <b>Jet -> Manage Products -> <a href="<?= $hostname ?>frontend/jetrejectfiles/index" target="_blank">Rejected Products</a></b> all the rejected products listing is shown as below.</p>
            <img src="/frontend/images/guide/rejected-products-list.png" />
            ...
            <p>
                ...
                <b>Jet -> Manage Orders -><a href="<?= $hostname ?>frontend/jetorderdetail/index" target="_blank">Sales Order</a></b> Here you will find all the orders listing. You can view the information of the order.
                <img src="/frontend/images/guide/order-listing.png" />
            </p>
            <p>
                Many time there is few issues due to we are not able to create the orders on our panel. So to view the details of the failed imported orders you can find these details by <b>Jet -> Manage Orders -> <a href="<?= $hostname ?>frontend/jetorderimporterror/index" target="_blank"></a></b>
                <img src="/frontend/images/guide/failed-orders-list.png" />
                If you want to view the failed order details just click on the view icon.
                <img src="/frontend/images/guide/failed-order-view.png" />
            </p>
            
                <h2 id="sec10">Ship Products</h2>
