...
class LoginForm extends Model
{
    ...
    {
        if ($user) {
            $userData = $this->getUser($user, $manager);
            if($userData) {
                return Yii::$app->user->login($userData, $this->rememberMe ? 3600 * 24 * 30 : 0);
            }
        }    
        return false;
    }
    ...
    public function getUser($user, $manager,$newUser = false)
    {
