...
/**
 * NeweggCanPaymentSearch represents the model behind the search form about `backend\models\NeweggCanPayment`.
 */
class NeweggCanPaymentSearch extends NeweggCanPayment
{
    /**
     * @inheritdoc
     */
