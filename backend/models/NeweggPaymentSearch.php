...
/**
 * NeweggPaymentSearch represents the model behind the search form about `backend\models\NeweggPayment`.
 */
class NeweggPaymentSearch extends NeweggPayment
{
    /**
     * @inheritdoc
     */
