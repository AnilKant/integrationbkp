...
/**
 * MagentoOnbuyInfoSearch represents the model behind the search form about `backend\models\MagentoOnbuyInfo`.
 */
class MagentoOnbuyInfoSearch extends MagentoOnbuyInfo
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['domain', 'email', 'total_revenue', 'install_on', 'framework','onbuy_username','onbuy_password'], 'safe'],
        ];
    }
