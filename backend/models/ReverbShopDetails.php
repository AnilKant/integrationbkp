 ...
 * @property string $app_handler
 *
 * @property MerchantDb $merchant
 */
class ReverbShopDetails extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['install_date', 'uninstall_dates', 'expire_date', 'last_login', 'updated_at', 'created_at','app_handler'], 'safe'],
