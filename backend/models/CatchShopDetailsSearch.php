...
/**
 * CatchShopDetailsSearch represents the model behind the search form about `backend\models\CatchShopDetails`.
 */
class CatchShopDetailsSearch extends CatchShopDetails
{
    /**
     * @inheritdoc
     */
...
//var_dump($this->status);die;
        $query = CatchShopDetails::find()->select([TableConstant::SHOP_DETAILS.'.*','merchant.shopurl','merchant.email','merchant.seller_username','merchant.seller_password','merchant.verified_mobile',TableConstant::INSTALLATION.'.status','merchant.owner_name']);
