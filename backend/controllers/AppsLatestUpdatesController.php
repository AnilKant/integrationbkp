...
use backend\models\AppsLatestUpdatesSearch;
 ...
 */
class AppsLatestUpdatesController extends MainController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new AppsLatestUpdatesSearch();
    ...
    public function actionCreate()
    {
        ...
        $model = new AppsLatestUpdates();
        if ($model->load(Yii::$app->request->post()))
        {
            $model->expired_in = date('Y-m-d', strtotime(date('Y-m-d'). ' + '.$model->expired_in.' days'));
            $model->save();
    ...
    {
        if (($model = AppsLatestUpdates::findOne($id)) !== null) {
            return $model;
        } else {
