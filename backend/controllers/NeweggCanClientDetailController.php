...
use Yii;
use backend\models\NeweggCanClientDetail;
use backend\models\NeweggCanClientDetailSearch;
 ...
 */
class NeweggCanClientDetailController extends MainController
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new NeweggCanClientDetailSearch();
    ...
    {
        $model = new NeweggCanClientDetail();
    ...
    {
        if (($model = NeweggCanClientDetail::findOne($id)) !== null) {
            return $model;
        } else {
