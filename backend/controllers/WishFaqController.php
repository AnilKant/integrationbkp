...
use Yii;
use backend\models\WishFaq;
use backend\models\WishFaqSearch;
 ...
 */
class WishFaqController extends MainController
{
    /**
     * @inheritdoc
     */
    ...
    {
        if (($model = WishFaq::findOne($id)) !== null) {
            return $model;
        } else {
