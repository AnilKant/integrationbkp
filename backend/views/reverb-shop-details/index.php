...
/* @var $searchModel backend\models\ReverbShopDetailsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Reverb Shop Details';
$this->params['breadcrumbs'][] = $this->title;
$helper = new IntegrationLoginHelper();
$loginUrl = $helper->getLoginasMerchantUrl('reverb');
$urlRegister = \yii\helpers\Url::toRoute(['reverb-shop-details/view-merchant']);
...
<div class="Reverb-shop-details-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url,$model)
                    {
                        return Html::a(
                            ...
                            ['/reverb-shop-details/update','id'=>$model->id],
                            ['title' => 'Edit User']
                        );
                    },
                ],
