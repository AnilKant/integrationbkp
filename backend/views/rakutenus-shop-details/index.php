...
/* @var $searchModel backend\models\RakutenusShopDetailsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Rakuten US Shop Details';
$this->params['breadcrumbs'][] = $this->title;
$helper = new IntegrationLoginHelper();
$loginUrl = $helper->getLoginasMerchantUrl('rakuten');
...
<div class="rakutenus-shop-details-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url,$model)
                    {
                        return Html::a(
                            ...
                            ['/rakutenus-shop-details/update','id'=>$model->id],
                            ['title' => 'Edit User']
                        );
                    },
                ],
