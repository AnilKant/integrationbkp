...
$urlRegistered = \yii\helpers\Url::toRoute(['wishshopdetails/view-merchant']);

$helper = new IntegrationLoginHelper();
$loginUrl = $helper->getLoginasMerchantUrl('wish');
        ...
        'columns' => [
           [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url,$model)
                    {
                        return Html::a(
                            ...
                            ['/wishshopdetails/update','id'=>$model->id],
                            ['title' => 'Edit User']
                        );
                    },
            ...
            [
                ...
                'value' => function($data){
                    ...
                    if ($data['install_status']) {
                        ...
                        $installStatus = "UnInstalled" . "<br>(" . $data['uninstall_dates'] . ")";
                    }
            ...
            [
                ...
                'attribute' => 'already_selling',
                'format' => 'html',
                'value' => function($data){
                    $val = '';
                    $already_selling = $data['already_selling'];
                    if($already_selling == 1){
                        $val = 'Yes';
                    }
                    elseif($already_selling == 0){
                        $val = 'No';
                    }
                    return $val;
                },
            ...
            /*[
                'label'=>'Wish MID',
                'attribute' => 'wish_merchant_id',
                'format' => 'html',
                'value' => function($data){
                    return $data['wish_merchant_id'];
                },
            ...
            [
                ...
                'attribute' => 'verified_mobile',
                'format' => 'html',
                'value' => function($data){
                    $verified_number = $data['verified_mobile'];

                    if (!empty($data['country_code'])) {
                        $verified_number = $data['country_code'].$verified_number;
                    }
