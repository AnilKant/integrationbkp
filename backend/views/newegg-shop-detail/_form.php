...
<div class="newegg-shop-detail-form">
    ...
    <?= $form->field($model, 'purchase_status')->dropDownList(['Trial'=>'Trial','Trial Expired'=>'Trial Expired','Purchased'=>'Purchased','Not Purchased'=>'Not Purchased','License Expired'=>'License Expired'],['prompt'=>'Select Option']) ?>
    ...
    <?= $form->field($model, 'app_status')->dropDownList(['install'=>'Install','uninstall'=>'Uninstall'],['prompt'=>'Select Option']) ?>
