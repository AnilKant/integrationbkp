...
<div class="tophattershopdetails-form">
    ...
    <?= $form->field($model, 'uninstall_dates')->widget(
    ...
    <?= $form->field($model, 'purchase_status')->dropDownList(["4"=>"Not Purchased","0"=>"Recurring Trial","1"=>"Purchased","2"=>"Trial Expired","3"=>"License Expired"],['prompt'=>'Select option']) ?>
