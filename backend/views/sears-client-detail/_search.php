...
/* @var $model frontend\modules\sears\models\SearsRegistrationSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sears-registration-search">
    ...
    <?php // echo $form->field($model, 'selling_on_sears') ?>

    <?php // echo $form->field($model, 'selling_on_sears_source') ?>

    <?php // echo $form->field($model, 'other_selling_source') ?>

    <?php // echo $form->field($model, 'approved_by_sears') ?>
