...
/* @var $searchModel backend\models\CatchShopDetailsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Catch Shop Details';
$this->params['breadcrumbs'][] = $this->title;
$helper = new IntegrationLoginHelper();
$loginUrl = $helper->getLoginasMerchantUrl('catchmp');
$urlRegister = \yii\helpers\Url::toRoute(['catch-shop-details/view-merchant']);
...
<div class="catch-shop-details-index">
                ...
                'buttons' => [
                    ...
                    'update' => function ($url,$model)
                    {
                        return Html::a(
                            ...
                            ['/catch-shop-details/update','id'=>$model->id],
                            ['title' => 'Edit User']
                        );
                    },
                ],
