...
<div class="pricefalls-registration-form">
    ...
    <?= $form->field($model, 'selling_on_pricefalls')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'selling_on_pricefalls_source')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'other_selling_source')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'approved_by_pricefalls')->textInput(['maxlength' => true]) ?>
